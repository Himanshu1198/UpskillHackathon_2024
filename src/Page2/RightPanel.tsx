...
const RightPanel = () => {
  ...
  return (
    <>      <div className="right-panel m-0 bg-gray-100 text-gray-900 overflow-y-auto">
        <div className="rpanel1 w-fit overflow-y-auto">
          <div className="container-panel grid grid-cols-12 mx-auto bg-gray-50 max-w-max">
            <div
