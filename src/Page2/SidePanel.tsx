...
<div className="flex flex-col justify-center max-w-xs p-6 shadow-lg rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
	...
	<div className="space-y-4 text-center divide-y dark:divide-gray-300">
      ...
      <div className="text-center mt-6">
        ...
        <div className="connections1 flex flex-col mt-3 items-center cursor-pointer justify-center" onClick={handleConnectionsClick}>
      ...
      <div className="text-center mt-6">
        ...
        <div className="flex flex-col mt-3  items-center justify-center">
          <div className="mb-2 font-medium">
            ...
            <span className="ml-2 text-gray-500">97k follows</span>
          </div>
          <div className="mb-2">
            <span className="text-lg">#WebDevelopment</span>
            <span className="ml-2 text-gray-500">85k follows</span>
          </div>
          <div className="mb-2">
            <span className="text-lg">#ArtificialIntelligence</span>
            <span className="ml-2 text-gray-500">76k follows</span>
          </div>
          <div className="mb-2">
            <span className="text-lg">#Internships</span>
            <span className="ml-2 text-gray-500">100k follows</span>
          </div>
        </div>
      </div>

      {isListOpen && <List onClose={handleCloseList} />}
...
//       <div className="text-center mt-6">
//         <h2 className="text-lg font-bold">Your Connections</h2>
//         <div className="connections1 flex flex-col mt-3 items-center justify-center">
//           <div className="flex -space-x-4">
//             <img alt="" className="w-12 h-12 border rounded-full dark:bg-gray-500 dark:border-gray-300" src="https://source.unsplash.com/40x40/?portrait?1" />
//             <img alt="" className="w-12 h-12 border rounded-full dark:bg-gray-500 dark:border-gray-300" src="https://source.unsplash.com/40x40/?portrait?2" />
//             <img alt="" className="w-12 h-12 border rounded-full dark:bg-gray-500 dark:border-gray-300" src="https://source.unsplash.com/40x40/?portrait?3" />
